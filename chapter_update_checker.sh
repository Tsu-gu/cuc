...
wget https://archiveofourown.org/works/13874982/navigate -qP $directory
grep "/works/13874982/chapters" navigate >> $directory/cuc-output.txt
...
# -FoE PH Speak-
echo "Searching for available chapters..."
wget https://www.fimfiction.net/story/download/360410/html -qP $directory
grep "https://www.fimfiction.net/story/360410" html >> $directory/cuc-output.txt
